...
// Bare-metal RV32IMFC_Zicsr for the HiSilicon WS63 application core:
//   * hardware single-precision float (F) with the `ilp32f` ABI, and
//   * NO atomic ('a') extension.
...
pub(crate) fn target() -> Target {
    Target {
        ...
        metadata: TargetMetadata {
            description: Some(
                "Bare RISC-V (RV32IMFC ISA, hardware single-float, no atomics) — HiSilicon WS63"
                    .into(),
            ),
            tier: Some(3),
